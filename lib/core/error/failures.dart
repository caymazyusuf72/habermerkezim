...
class GeneralFailure extends Failure {
  ...
  factory GeneralFailure.invalidInput(String details) {
    return GeneralFailure('Geçersiz giriş: $details', code: 'INVALID_INPUT');
  }
}
...
class ValidationFailure extends Failure {
  ...
  factory ValidationFailure.emptyField(String fieldName) {
    return ValidationFailure('$fieldName boş olamaz', code: 'EMPTY_FIELD');
  }

  factory ValidationFailure.invalidUrl(String url) {
    return ValidationFailure('Geçersiz URL formatı: $url', code: 'INVALID_URL');
  }
}
