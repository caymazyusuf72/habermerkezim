...
class DefaultRssSources {
  static List<RssSource> get sources => [
    ...
    RssSource(
      ...
      category: 'magazin',
      description: 'Sabah magazin haberleri',
      createdAt: DateTime.now(),
      iconUrl: 'https://www.sabah.com.tr/favicon.ico',
    ),
    RssSource(
      ...
      category: 'magazin',
      description: 'Milliyet magazin haberleri',
      createdAt: DateTime.now(),
      iconUrl: 'https://www.milliyet.com.tr/favicon.ico',
    ),
    RssSource(
    ...
    RssSource(
      id: 'ensonhaber_magazin',
      name: 'Ensonhaber Magazin',
      url: 'https://www.ensonhaber.com/rss/magazin.xml',
      category: 'magazin',
      description: 'Ensonhaber magazin haberleri',
      createdAt: DateTime.now(),
      iconUrl: 'https://www.ensonhaber.com/favicon.ico',
    ),
    RssSource(
      id: 'haberturk_magazin',
      name: 'Habertürk Magazin',
      url: 'https://www.haberturk.com/rss/kategori/magazin.xml',
      category: 'magazin',
      description: 'Habertürk magazin haberleri',
      createdAt: DateTime.now(),
      iconUrl: 'https://www.haberturk.com/favicon.ico',
    ),
    RssSource(
      id: 'hurses_magazin',
      name: 'Hürses',
      url: 'https://www.hurses.com.tr/rss',
      category: 'magazin',
      description: 'Hürses magazin haberleri',
      createdAt: DateTime.now(),
      iconUrl: 'https://www.hurses.com.tr/favicon.ico',
    ),
